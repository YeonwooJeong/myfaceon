...
public class NewCustomActivity extends AdlibActivity implements OnClickListener{
...
//			 Log.d("[screenshot]", " : " + container.getDrawingCache());
			...
			try {
				...
				fos = new FileOutputStream(fileRoute+"/FaceOn/"+new_str+str_mode+"-select"+"-"+str_season+"-"+str_name+".png");//
				Log.d("[screenshot]", " : " + container.getDrawingCache());
				...
				sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.parse("file://"
						+ Environment.getExternalStorageDirectory()+"/FaceOn/"+new_str+str_mode+"-select"+"-"+str_season+"-"+str_name+".png")));
			...
			File files = new File(fileRoute,"/FaceOn/"+new_str+str_mode+"-select"+"-"+str_season+"-"+str_name+".png");

			if(files.exists()==true)  //파일유무확인
			{
				Intent intentSend  = new Intent(Intent.ACTION_SEND);
				intentSend.setType("image/*");
				intentSend.putExtra(Intent.EXTRA_STREAM, Uri.parse(fileRoute+"/FaceOn/"+new_str+str_mode+"-select"+"-"+str_season+"-"+str_name+".png"));
...
//		 int st_temp = list.get(0)*16 + list.get(1)*9 + list.get(2)*7 + list.get(3)*5
//				+ list.get(4)*10 + list.get(5)*6/*위치선정*/ +list.get(6)*5 + list.get(7)*10 + list.get(8)*8
//				+ list.get(9)*5 + list.get(10)*5 + list.get(11)*7 + list.get(12)*8;
//		int st_sum = st_temp;
...
//		map.put("LS", st_avg);
//
//		int cf_sum = list.get(0)*17 + list.get(1)*9 + list.get(2)*8
//				+ list.get(3)*5 + list.get(4)*6/*위치선정*/ + list.get(5)*8 + list.get(6)*8 + list.get(7)*8
//				+ list.get(8)*5 + list.get(9)*11
//				+ list.get(10)*12 + list.get(11)*4/*시야*/;
//		int cf_avg = (cf_sum / 100)-1;
//		map.put("CF", cf_avg);
//
//		int lf_sum = list.get(0)*17 + list.get(1)*9 + list.get(2)*8
//				+ list.get(3)*5 + list.get(4)*6/*위치선정*/ + list.get(5)*8 + list.get(6)*8 + list.get(7)*8
//				+ list.get(8)*5 + list.get(9)*11
//				+ list.get(10)*12 + list.get(11)*4/*시야*/;
...
//		map.put("RF", lf_avg);
//
//		int lw_sum = list.get(0)*4 + list.get(1)*3 + list.get(2)*12/*위치선정*/ + list.get(3)*9
//				+ list.get(4)*11 + list.get(5)*5 + list.get(6)*5
//				+ list.get(7)*10 + list.get(8)*12 + list.get(9)*10
//				+ list.get(10)*15 + list.get(11)*4;
//		int lw_avg = (lw_sum / 100)-1;
//		map.put("LW", lw_avg);
//		map.put("RW", lw_avg);
//
//		int cam_sum = list.get(0)*7 + list.get(1)*9
//				+ list.get(2)*9 + list.get(3)*5 + list.get(4)*5/*가속력*/ + list.get(5)*5/*민첩성*/
//				+ list.get(6)*5 + list.get(7)*15
...
//		map.put("LAM", cam_avg);
//
//		int cm_sum = list.get(0)*10/*골결정력*/ + list.get(1)*5 + list.get(2)*6
//				+ list.get(3)*5 + list.get(4)*5 + list.get(5)*15
//				+ list.get(6)*12 + list.get(7)*10 + list.get(8)*10 + list.get(9)*8/*가로채기*/
//				+ list.get(10)*10 + list.get(11)*5;
//		int cm_avg = cm_sum / 100;
//		map.put("CM", cm_avg+1);
//		map.put("RCM", cm_avg+1);
//		map.put("LCM", cm_avg+1);
//
//		int cdm_sum = list.get(0)*5
//				+ list.get(1)*5 + list.get(2)*7 + list.get(3)*10+ list.get(4)*8 +
//				list.get(5)*10+ list.get(6)*8/*가로채기*/ + list.get(7)*5 + list.get(8)*15
//				+ list.get(9)*10 + list.get(10)*12 + list.get(11)*5;
//		int cdm_avg = (cdm_sum / 100)+3;
//		map.put("CDM", cdm_avg);
//		map.put("RDM", cdm_avg);
//		map.put("LDM", cdm_avg);
//
//		int lm_sum = list.get(0)*8/*골결정력*/ + list.get(1)*6 + list.get(2)*8 + list.get(3)*7
//				+ list.get(4)*3 + list.get(5)*5 + list.get(6)*12
//				+ list.get(7)*7 + list.get(8)*13 + list.get(9)*12 +  list.get(10)*13
//				+ list.get(11)*6;
//		int lm_avg = lm_sum / 100;
//		map.put("LM", lm_avg);
//		map.put("RM", lm_avg);
//
//		int cb_sum = list.get(0)*10 + list.get(1)*5 + list.get(2)*5
//				+ list.get(3)*4 + list.get(4)*10 + list.get(5)*4 + list.get(6)*4
//				+ list.get(7)*3/*가로채기*/ + list.get(8)*15 + list.get(9)*10
//				+ list.get(10)*20 + list.get(11)*10;
//		int cb_avg = (cb_sum / 100)-1;
//		map.put("CB", cb_avg);
//		map.put("RCB", cb_avg);
//		map.put("LCB", cb_avg);
//
//
//		int lb_sum = list.get(0)*8 + list.get(1)*7 + list.get(2)*7/*가속력*/ + list.get(3)*7
//				+ list.get(4)*5 + list.get(5)*6 + list.get(6)*5
//				+ list.get(7)*7 + list.get(8)*8/*가로채기*/ + list.get(9)*11 + list.get(10)*15
//				+ list.get(11)*15;
//		int lb_avg = (lb_sum / 100)-1;
//		map.put("LB", lb_avg);
//		map.put("RB", lb_avg);
//
//
//		int rwb_sum = list.get(0)*8 + list.get(1)*7
//				+ list.get(2)*5 + list.get(3)*8 + list.get(4)*8 + list.get(5)*8
//				+ list.get(6)*10 + list.get(7)*5 + list.get(8)*7/*가로채기*/ + list.get(9)*12 + list.get(10)*10
//				+ list.get(11)*12;
//		int rwb_avg = rwb_sum / 100;
//		map.put("RWB", rwb_avg);
//		map.put("LWB", rwb_avg);
//
//		int sw_sum = list.get(0)*8 + list.get(1)*9
//				+ list.get(2)*5 + list.get(3)*5 + list.get(4)*6 + list.get(5)*7
//				+ list.get(6)*10/*가로채기*/ + list.get(7)*15 + list.get(8)*10 + list.get(9)*15
//				+ list.get(10)*10 /*적극성*/;
//		int sw_avg = sw_sum / 100;
//		map.put("SW", sw_avg);
//
//
//		int gk_sum = list.get(0)*11 + list.get(1)*24
//				+ list.get(2)*16 + list.get(3)*6 + list.get(4)*24 + list.get(5)*24;
//		int gk_avg = (gk_sum / 100)-4;
//		map.put("GK", gk_avg);



		int st_temp = list.get(0)*18 + list.get(1)*10 + list.get(2)*3 + list.get(3)*2
				+ list.get(4)*10 + list.get(5)*13/*위치선정*/ +list.get(6)*5 + list.get(7)*4 + list.get(8)*8
				+ list.get(9)*5 + list.get(10)*5 + list.get(11)*10 + list.get(12)*7;
		int st_sum = st_temp;
		int st_avg = (st_sum / 100);
		map.put("ST", st_avg);
		map.put("RS", st_avg);
		...
		int cf_sum = list.get(0)*11 + list.get(1)*5 + list.get(2)*4
				+ list.get(3)*2 + list.get(4)*13/*위치선정*/ + list.get(5)*5 + list.get(6)*5 + list.get(7)*9
				+ list.get(8)*9 + list.get(9)*15
				+ list.get(10)*14 + list.get(11)*8/*시야*/;
		int cf_avg = (cf_sum / 100);
		map.put("CF", cf_avg);

		int lf_sum = list.get(0)*11 + list.get(1)*5 + list.get(2)*4
				+ list.get(3)*2 + list.get(4)*13/*위치선정*/ + list.get(5)*5 + list.get(6)*5 + list.get(7)*9
				+ list.get(8)*9 + list.get(9)*15
				+ list.get(10)*14 + list.get(11)*8/*시야*/;
		int lf_avg = lf_sum / 100;
		...
		int cam_sum = list.get(0)*7 + list.get(1)*5
				+ list.get(2)*9 + list.get(3)*3 + list.get(4)*4/*가속력*/ + list.get(5)*3/*민첩성*/
				+ list.get(6)*7 + list.get(7)*16
				+ list.get(8)*4 + list.get(9)*15 + list.get(10)*13 + list.get(11)*14;
		int cam_avg = cam_sum / 100;
		map.put("CAM", cam_avg);
		map.put("RAM", cam_avg);
		map.put("LAM", cam_avg);
		...
		int cdm_sum = list.get(0)*7
				+ list.get(1)*6 + list.get(2)*4 + list.get(3)*14+ list.get(4)*10 +
				list.get(5)*10+ list.get(6)*14/*가로채기*/ + list.get(7)*4 + list.get(8)*12
				+ list.get(9)*5 + list.get(10)*9 + list.get(11)*5;
		int cdm_avg = (cdm_sum / 100);
		map.put("CDM", cdm_avg);
		map.put("RDM", cdm_avg);
		map.put("LDM", cdm_avg);

		int lm_sum = list.get(0)*6/*골결정력*/ + list.get(1)*8 + list.get(2)*6 + list.get(3)*7
				+ list.get(4)*7 + list.get(5)*5 + list.get(6)*11
				+ list.get(7)*5 + list.get(8)*10 + list.get(9)*13 +  list.get(10)*15
				+ list.get(11)*7;
		int lm_avg = lm_sum / 100;
		map.put("LM", lm_avg);
		map.put("RM", lm_avg);

		int cb_sum = list.get(0)*10 + list.get(1)*2 + list.get(2)*5
				+ list.get(3)*3 + list.get(4)*10 + list.get(5)*5 + list.get(6)*4
				+ list.get(7)*13/*가로채기*/ + list.get(8)*17 + list.get(9)*10
				+ list.get(10)*14 + list.get(11)*7;
		...
		int lb_sum = list.get(0)*4 + list.get(1)*7 + list.get(2)*5/*가속력*/ + list.get(3)*8
				+ list.get(4)*8 + list.get(5)*7 + list.get(6)*9
				+ list.get(7)*7 + list.get(8)*12/*가로채기*/ + list.get(9)*11 + list.get(10)*14
				+ list.get(11)*8;
		...
		int gk_sum = list.get(0)*11 + list.get(1)*21
				+ list.get(2)*21 + list.get(3)*5 + list.get(4)*21 + list.get(5)*21;
...
//		 System.out.println(i+"번째"+map.get(i));
//		 }
	}
...
class NewValueComparator implements Comparator<Object> {
	Map<String, Double> base;

	public NewValueComparator(Map<String, Double> base) {
		this.base = base;
	}
