...
public class CustomFullActivity extends AdlibActivity implements OnClickListener{
...
// 	private ImageButton mButton;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.custom_full);//result.xml출력
...
//			 Log.d("[screenshot]", " : " + container.getDrawingCache());
			...
			try {
				...
				fos = new FileOutputStream(fileRoute+"/FaceOn/"+str_mode+"-"+str_season+"-"+str_name+".png");//
				Log.d("[screenshot]", " : " + container.getDrawingCache());
				...
				sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.parse("file://"
						+ Environment.getExternalStorageDirectory()+"/FaceOn/"+str_mode+"-"+str_season+"-"+str_name+".png")));
			...
			File files = new File(fileRoute,"/FaceOn/"+str_mode+"-"+str_season+"-"+str_name+".png");

			if(files.exists()==true)  //파일유무확인
			{
				Intent intentSend  = new Intent(Intent.ACTION_SEND);
				intentSend.setType("image/*");
				intentSend.putExtra(Intent.EXTRA_STREAM, Uri.parse(fileRoute+"/FaceOn/"+str_mode+"-"+str_season+"-"+str_name+".png"));
...
//	}
	...
	public void allAvg(String str2, String str3, String str4) {
		...
		// }
		int st_temp = list.get(0)*20 + list.get(1)*10 + list.get(3)*7 + list.get(4)*5
				+ list.get(7)*10 + list.get(9)*5 + list.get(10)*10 + list.get(12)*8
				+ list.get(15)*5 + list.get(17)*5 + list.get(20)*7 + list.get(21)*8;
		int st_sum = st_temp;
		...
		int cf_sum = list.get(0)*17 + list.get(1)*9 + list.get(3)*8 + list.get(4)*3
				+ list.get(7)*5 + list.get(9)*8 + list.get(10)*8 + list.get(12)*8
				+ list.get(15)*3 + list.get(17)*5 + list.get(19)*3 + list.get(20)*11
				+ list.get(21)*12;
		int cf_avg = cf_sum / 100;
		map.put("CF", cf_avg);

		int lf_sum = list.get(0)*12 + list.get(1)*8 + list.get(3)*9 + list.get(4)*4
				+ list.get(7)*5 + list.get(9)*8 + list.get(10)*8 + list.get(12)*8
				+ list.get(15)*3 + list.get(17)*5 + list.get(19)*8 + list.get(20)*10
				+ list.get(21)*12;
		int lf_avg = lf_sum / 100;
		map.put("LF", lf_avg);

		int rf_sum = list.get(0)*12 + list.get(1)*8 + list.get(3)*9 + list.get(4)*4
				+ list.get(7)*5 + list.get(9)*8 + list.get(10)*8 + list.get(12)*8
				+ list.get(15)*3 + list.get(17)*5 + list.get(19)*8 + list.get(20)*10
				+ list.get(21)*12;
		...
		int lw_sum = list.get(0)*4 + list.get(1)*3 + list.get(3)*3 + list.get(9)*9
				+ list.get(10)*11 + list.get(11)*5 + list.get(12)*5 + list.get(14)*4
				+ list.get(17)*10 + list.get(18)*5 + list.get(19)*12 + list.get(20)*10
				+ list.get(21)*15 + list.get(24)*4;
		int lw_avg = lw_sum / 100;
		map.put("LW", lw_avg);

		int rw_sum = list.get(0)*4 + list.get(1)*3 + list.get(3)*3 + list.get(9)*9
				+ list.get(10)*11 + list.get(11)*5 + list.get(12)*5 + list.get(14)*4
				+ list.get(17)*10 + list.get(18)*5 + list.get(19)*12 + list.get(20)*10
				+ list.get(21)*15 + list.get(24)*4;
		...
		int cam_sum = list.get(0)*7 + list.get(1)*5 + list.get(3)*9 + list.get(7)*4
				+ list.get(8)*9 + list.get(9)*5 + list.get(12)*5 + list.get(17)*15
				+ list.get(18)*7 + list.get(20)*12 + list.get(21)*12 + list.get(24)*10;
		int cam_avg = cam_sum / 100;
		map.put("CAM", cam_avg);

		int cm_sum = list.get(3)*5 + list.get(7)*5 + list.get(8)*6 + list.get(9)*5
				+ list.get(12)*5 + list.get(14)*5 + list.get(15)*4 + list.get(17)*15
				+ list.get(18)*12 + list.get(20)*10 + list.get(21)*10 + list.get(24)*10
				+ list.get(23)*3 + list.get(25)*5;
		int cm_avg = cm_sum / 100;
		map.put("CM", cm_avg);

		int cdm_sum = list.get(7)*5 + list.get(8)*10 + list.get(9)*5 + list.get(12)*5
				+ list.get(14)*5 + list.get(15)*7 + list.get(17)*10 + list.get(18)*8
				+ list.get(20)*10 + list.get(24)*5 + list.get(25)*10 + list.get(26)*5
				+ list.get(27)*10 + list.get(28)*5;
		int cdm_avg = cdm_sum / 100;
		map.put("CDM", cdm_avg);

		int lm_sum = list.get(3)*3 + list.get(8)*6 + list.get(9)*8 + list.get(10)*7
				+ list.get(11)*3 + list.get(12)*5 + list.get(14)*5 + list.get(17)*12
				+ list.get(18)*7 + list.get(19)*13 + list.get(20)*12 +  list.get(21)*13
				+ list.get(24)*6;
		int lm_avg = lm_sum / 100;
		map.put("LM", lm_avg);

		int rm_sum = list.get(3)*3 + list.get(8)*6 + list.get(9)*8 + list.get(10)*7
				+ list.get(11)*3 + list.get(12)*5 + list.get(14)*5 + list.get(17)*12
				+ list.get(18)*7 + list.get(19)*13 + list.get(20)*12 +  list.get(21)*13
				+ list.get(24)*6;
		...
		int cb_sum = list.get(7)*10 + list.get(8)*3 + list.get(9)*5 + list.get(12)*5
				+ list.get(13)*4 + list.get(15)*10 + list.get(17)*4 + list.get(20)*4
				+ list.get(25)*15 + list.get(26)*10 + list.get(27)*20 + list.get(28)*10;
		int cb_avg = cb_sum / 100;
		map.put("CB", cb_avg);

		int lb_sum = list.get(7)*8 + list.get(8)*8 + list.get(9)*5 + list.get(12)*7
				+ list.get(14)*5 + list.get(15)*5 + list.get(17)*6 + list.get(19)*5
				+ list.get(20)*7 + list.get(25)*14 + list.get(26)*10 + list.get(27)*15
				+ list.get(28)*5;
		int lb_avg = lb_sum / 100;
		map.put("LB", lb_avg);

		int rb_sum = list.get(7)*8 + list.get(8)*8 + list.get(9)*5 + list.get(12)*7
				+ list.get(14)*5 + list.get(15)*5 + list.get(17)*6 + list.get(19)*5
				+ list.get(20)*7 + list.get(25)*14 + list.get(26)*10 + list.get(27)*15
				+ list.get(28)*5;
		...
		int rwb_sum = list.get(7)*5 + list.get(8)*9 + list.get(9)*5 + list.get(10)*5
				+ list.get(12)*5 + list.get(14)*8 + list.get(17)*8 + list.get(19)*8
				+ list.get(20)*10 + list.get(21)*5 + list.get(25)*12 + list.get(26)*8
				+ list.get(27)*12;
		int rwb_avg = rwb_sum / 100;
		map.put("RWB", rwb_avg);

		int lwb_sum = list.get(7)*5 + list.get(8)*9 + list.get(9)*5 + list.get(10)*5
				+ list.get(12)*5 + list.get(14)*8 + list.get(17)*8 + list.get(19)*8
				+ list.get(20)*10 + list.get(21)*5 + list.get(25)*12 + list.get(26)*8
				+ list.get(27)*12;
		...
		int sw_sum = list.get(7)*7 + list.get(8)*22 + list.get(10)*4 + list.get(12)*9
				+ list.get(13)*3 + list.get(15)*5 + list.get(17)*6 + list.get(20)*7
				/*+ list.get(23)**/ + list.get(25)*15 + list.get(26)*7 + list.get(27)*15;
		int sw_avg = sw_sum / 100;
		map.put("SW", sw_avg);

		int gk_sum = list.get(12)*3 + list.get(13)*3 + list.get(29)*24
				+ list.get(30)*16 + list.get(31)*6 + list.get(32)*24 + list.get(33)*24;
