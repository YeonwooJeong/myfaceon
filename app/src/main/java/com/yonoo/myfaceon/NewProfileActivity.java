...
public class NewProfileActivity extends AdlibActivity implements OnClickListener{
	...
	EditText et_name,et_national,et_birth,et_height,et_weight,et_foot_right,et_foot_left,hidden,position2,position3,position4,et_star,
			...
			,et_ability21,et_ability22,et_ability23,et_ability24,et_ability25,et_ability26,et_ability27,et_ability28,
			et_ability29,et_ability30,et_ability31,et_ability32,et_ability33,et_ability34,et_ability35
			...
			et_value30,et_value31,et_value32,et_value33,et_value34,et_value35;

	String tag,season;
	Spinner spinner,spinner2,spinner3,spinner4,country,hiddenStat,force,body,consist,special_spinner,legend_spinner,
			style1,style2,style3,forward_participation,defence_participation;
	String language;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.new_profile);//custom.xml출력
...
//		Toast.makeText(getApplicationContext(), language, Toast.LENGTH_LONG).show();
		...
		ArrayAdapter<CharSequence> hiddenAdapter = ArrayAdapter.createFromResource(this, R.array.new_hidden_array,
				android.R.layout.simple_spinner_item);
...
//					   String str_hidden = "";
		...
		/*공격 참여도*/
		forward_participation = (Spinner)findViewById(R.id.spinner_forward_participation);

		ArrayAdapter<CharSequence> adapter_forward_participation = ArrayAdapter.createFromResource(this, R.array.forward_participation_array,
				android.R.layout.simple_spinner_item);

		adapter_forward_participation.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		forward_participation.setAdapter(adapter_forward_participation);
		
		/*수비 참여도*/
		defence_participation = (Spinner)findViewById(R.id.spinner_defence_participation);

		ArrayAdapter<CharSequence> adapter_defence_participation = ArrayAdapter.createFromResource(this, R.array.defence_participation_array,
				android.R.layout.simple_spinner_item);

		adapter_defence_participation.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		defence_participation.setAdapter(adapter_defence_participation);
		
		/*칭호1*/
		style1 = (Spinner)findViewById(R.id.spinner_style1);

		ArrayAdapter<CharSequence> adapter_style1 = ArrayAdapter.createFromResource(this, R.array.style_array,
				android.R.layout.simple_spinner_item);

		adapter_style1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		style1.setAdapter(adapter_style1);
		
		/*칭호2*/
		style2 = (Spinner)findViewById(R.id.spinner_style2);

		ArrayAdapter<CharSequence> adapter_style2 = ArrayAdapter.createFromResource(this, R.array.style_array,
				android.R.layout.simple_spinner_item);

		adapter_style2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		style2.setAdapter(adapter_style2);
		
		/*칭호3*/
		style3 = (Spinner)findViewById(R.id.spinner_style3);

		ArrayAdapter<CharSequence> adapter_style3 = ArrayAdapter.createFromResource(this, R.array.style_array,
				android.R.layout.simple_spinner_item);

		adapter_style3.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		style3.setAdapter(adapter_style3);
...
//			 }else{
			...
			//공수참여도
			String str_forward_participation = forward_participation.getSelectedItem().toString();
			String str_defence_participation = defence_participation.getSelectedItem().toString();

			//칭호
			String str_style1 = style1.getSelectedItem().toString();
			String str_style2 = style2.getSelectedItem().toString();
			String str_style3 = style3.getSelectedItem().toString();
			...
			if(str_mode.equals("Original")){
				...
				it = new Intent(this, NewCustomActivity.class);
			}
			it.putExtra("it_new", "new");
...
//				 it.putExtra("it_country", str_country);	
			...
			it.putExtra("it_forward_participation", str_forward_participation); //공격참여도
			it.putExtra("it_defence_participation", str_defence_participation); //수비참여도
			//칭호
			it.putExtra("it_style1", str_style1);
			it.putExtra("it_style2", str_style2);
			it.putExtra("it_style3", str_style3);
...
//			 }
			...
			View layout = inflater.inflate(R.layout.new_dialog,(ViewGroup) findViewById(R.id.new_dialog));
			AlertDialog.Builder aDialog = new AlertDialog.Builder(NewProfileActivity.this);
...
//		}
	...
	public void st(){
		...
		et_ability6.setText("위치 선정");
		et_ability7.setText("속력");
		et_ability8.setText("가속력");
		et_ability9.setText("반응 속도");
		et_ability10.setText("몸싸움");
		et_ability11.setText("짧은 패스");
	...
	public void cm(){
		...
		et_ability6.setText("짧은 패스");
		et_ability7.setText("긴 패스");
		et_ability8.setText("볼 컨트롤");
		et_ability9.setText("드리블");
		et_ability10.setText("가로채기");
		et_ability11.setText("시야");
		et_ability12.setText("태클");
		et_ability13.setText(null);
		et_ability14.setText(null);
		et_ability15.setText(null);
		et_ability16.setText(null);
	...
	public void cdm(){
		...
		et_ability2.setText("스태미너");
		et_ability3.setText("몸싸움");
		et_ability4.setText("짧은 패스");
		et_ability5.setText("긴 패스");
		et_ability6.setText("볼 컨트롤");
		et_ability7.setText("가로채기");
		et_ability8.setText("시야");
	...
	public void wb(){
		et_star.setText("개인기");
		et_ability1.setText("속력");
		et_ability2.setText("가속력");
		et_ability3.setText("반응 속도");
		et_ability4.setText("스태미너");
		et_ability5.setText("짧은 패스");
		et_ability6.setText("크로스");
		et_ability7.setText("볼 컨트롤");
		et_ability8.setText("드리블");
	...
	public void b(){
		...
		et_ability2.setText("속력");
		et_ability3.setText("가속력");
		et_ability4.setText("반응 속도");
		et_ability5.setText("스태미너");
		et_ability6.setText("짧은 패스");
		et_ability7.setText("크로스");
		et_ability8.setText("볼 컨트롤");
		et_ability9.setText("가로채기");
		et_ability10.setText("태클");
		et_ability11.setText("슬라이딩 태클");
	...
	public void cb(){
		...
		et_ability3.setText("반응 속도");
		et_ability4.setText("점프");
		et_ability5.setText("몸싸움");
		et_ability6.setText("짧은 패스");
		et_ability7.setText("볼 컨트롤");
		et_ability8.setText("가로채기");
		et_ability9.setText("태클");
		et_ability10.setText("슬라이딩 태클");
		et_ability11.setText("대인 수비");
		et_ability12.setText("적극성");
	...
	public void sw(){
		et_star.setText("개인기");
		et_ability1.setText("헤딩");
		et_ability2.setText("반응 속도");
		et_ability3.setText("점프");
		et_ability4.setText("몸싸움");
		et_ability5.setText("짧은 패스");
		et_ability6.setText("볼 컨트롤");
		et_ability7.setText("가로채기");
		et_ability8.setText("태클");
		et_ability9.setText("슬라이딩 태클");
		et_ability10.setText("대인 수비");
		et_ability11.setText("적극성");
		et_ability12.setText(null);
		et_ability13.setText(null);
		et_ability14.setText(null);
		et_ability15.setText(null);
	...
	public void gk(){
		et_star.setText("개인기");
		et_ability1.setText("반응 속도");
		et_ability2.setText("GK 다이빙");
		et_ability3.setText("GK 핸들링");
		et_ability4.setText("GK 킥");
		et_ability5.setText("GK 반응속도");
		et_ability6.setText("GK 위치 선정");
		et_ability7.setText(null);
		et_ability8.setText(null);
		et_ability9.setText(null);
		et_ability10.setText(null);
		...
		//et_ability34.setText(null);	
		//et_ability35.setText(null);
		et_value7.setText(null);
		et_value8.setText(null);
	...
	public void all(){
		...
		et_ability23.setText("가로채기");
		et_ability24.setText("시야");
		et_ability25.setText("태클");
		et_ability26.setText("슬라이딩 태클");
		et_ability27.setText("대인 수비");
		et_ability28.setText("적극성");
		et_ability29.setText("GK 다이빙");
		et_ability30.setText("GK 핸들링");
		et_ability31.setText("GK 킥");
		et_ability32.setText("GK 반응속도");
		et_ability33.setText("GK 위치선정");
		//et_ability34.setText("GK 일대일");
		//et_ability35.setText("잠재력");
	...
	public void number(){
		...
		hidden.setText("예리한 감아차기, 다이버, 유리몸, 강철몸, 주발 선호");
		position2.setText("st");
		position3.setText("cam");
		position4.setText("cm");
		et_team.setText("갤럭시");
		et_number.setText("9");
		...
		//et_value34.setText("7");
		//et_value35.setText("90");
	...
	public void st_en(){
		...
		et_ability6.setText("Positioning");
		et_ability7.setText("Sprint Speed");
		et_ability8.setText("Acceleration");
		et_ability9.setText("Reactions");
		et_ability10.setText("Strength");
		et_ability11.setText("Short Pass");
	...
	public void w_en(){
		et_star.setText("Skill Moves");
		et_ability1.setText("Finishing");
		et_ability2.setText("Long Shots");
	...
	public void cm_en(){
		...
		et_ability6.setText("Short Pass");
		et_ability7.setText("Long Pass");
		et_ability8.setText("Ball Control");
		et_ability9.setText("Dribbling");
		et_ability10.setText("Interceptions");
		et_ability11.setText("Vision");
		et_ability12.setText("Standing Tackle");
		et_ability13.setText(null);
		et_ability14.setText(null);
		et_ability15.setText(null);
		et_ability16.setText(null);
	...
	public void cdm_en(){
		...
		et_ability2.setText("Stamina");
		et_ability3.setText("Strength");
		et_ability4.setText("Short Pass");
		et_ability5.setText("Long Pass");
		et_ability6.setText("Ball Control");
		et_ability7.setText("Interceptions");
		et_ability8.setText("Vision");
	...
	public void wb_en(){
		et_star.setText("Skill Moves");
		et_ability1.setText("Sprint Speed");
		et_ability2.setText("Acceleration");
		et_ability3.setText("Reactions");
		et_ability4.setText("Stamina");
		et_ability5.setText("Short Pass");
		et_ability6.setText("Crossing");
		et_ability7.setText("Ball Control");
		et_ability8.setText("Dribbling");
	...
	public void b_en(){
		...
		et_ability2.setText("Sprint Speed");
		et_ability3.setText("Acceleration");
		et_ability4.setText("Reactions");
		et_ability5.setText("Stamina");
		et_ability6.setText("Short Pass");
		et_ability7.setText("Crossing");
		et_ability8.setText("Ball Control");
		et_ability9.setText("Interceptions");
		et_ability10.setText("Standing Tackle");
		et_ability11.setText("Sliding Tackle");
	...
	public void cb_en(){
		...
		et_ability2.setText("Sprint Speed");
		et_ability3.setText("Reactions");
		et_ability4.setText("Jumping");
		et_ability5.setText("Strength");
		et_ability6.setText("Short Pass");
		et_ability7.setText("Ball Control");
		et_ability8.setText("Interceptions");
		et_ability9.setText("Standing Tackle");
		et_ability10.setText("Sliding Tackle");
		et_ability11.setText("Marking");
		et_ability12.setText("Aggression");
	...
	public void sw_en(){
		et_star.setText("Skill Moves");
		et_ability1.setText("Heading Accuracy");
		et_ability2.setText("Reactions");
		et_ability3.setText("Jumping");
		et_ability4.setText("Strength");
		et_ability5.setText("Short Pass");
		et_ability6.setText("Ball Control");
		et_ability7.setText("Interceptions");
		et_ability8.setText("Standing Tackle");
		et_ability9.setText("Sliding Tackle");
		et_ability10.setText("Marking");
		et_ability11.setText("Aggression");
		et_ability12.setText(null);
		et_ability13.setText(null);
		et_ability14.setText(null);
		et_ability15.setText(null);
	...
	public void gk_en(){
		et_star.setText("Skill Moves");
		et_ability1.setText("Reactions");
		et_ability2.setText("GK Diving");
		et_ability3.setText("GK Handling");
		et_ability4.setText("GK Kicking");
		et_ability5.setText("GK Reflexes");
		et_ability6.setText("GK Positioning");
		et_ability7.setText(null);
		et_ability8.setText(null);
		et_ability9.setText(null);
		et_ability10.setText(null);
	...
	public void all_en(){
		...
		et_ability23.setText("Interceptions");
		et_ability24.setText("Vision");
		et_ability25.setText("Standing Tackle");
		et_ability26.setText("Sliding Tackle");
		et_ability27.setText("Marking");
		et_ability28.setText("Aggression");
		et_ability29.setText("GK Diving");
		et_ability30.setText("GK Handling");
		et_ability31.setText("GK Kicking");
		et_ability32.setText("GK Reflexes");
		et_ability33.setText("GK Positioning");
		//et_ability34.setText("GK One On One");
		//et_ability35.setText("Potential");
	...
	public void st_th(){
		...
		et_ability6.setText("ยืนตำแหน่ง");
		et_ability7.setText("ความเร็ว");
		et_ability8.setText("สปีดต้น");
		et_ability9.setText("ปฏิกิริยา");
		et_ability10.setText("แข็งแกร่ง");
		et_ability11.setText("ส่งสั้น");
	...
	public void cm_th(){
		...
		et_ability6.setText("ส่งสั้น");
		et_ability7.setText("ส่งไกล");
		et_ability8.setText("ควบคุมบอล");
		et_ability9.setText("เลี้ยงบอล");
		et_ability10.setText("แย่งบอล");
		et_ability11.setText("อ่านเกม");
		et_ability12.setText("เข้าปะทะ");
		et_ability13.setText(null);
		et_ability14.setText(null);
		et_ability15.setText(null);
		et_ability16.setText(null);
	...
	public void cdm_th(){
		...
		et_ability2.setText("ความอึด");
		et_ability3.setText("แข็งแกร่ง");
		et_ability4.setText("ส่งสั้น");
		et_ability5.setText("ส่งไกล");
		et_ability6.setText("ควบคุมบอล");
		et_ability7.setText("แย่งบอล");
		et_ability8.setText("อ่านเกม");
	...
	public void wb_th(){
		et_star.setText("Skill Moves");
		et_ability1.setText("ความเร็ว");
		et_ability2.setText("สปีดต้น");
		et_ability3.setText("ปฏิกิริยา");
		et_ability4.setText("ความอึด");
		et_ability5.setText("ส่งสั้น");
		et_ability6.setText("เปิดบอล");
		et_ability7.setText("ควบคุมบอล");
		et_ability8.setText("เลี้ยงบอล");
	...
	public void b_th(){
		...
		et_ability2.setText("ความเร็ว");
		et_ability3.setText("สปีดต้น");
		et_ability4.setText("ปฏิกิริยา");
		et_ability5.setText("ความอึด");
		et_ability6.setText("ส่งสั้น");
		et_ability7.setText("เปิดบอล");
		et_ability8.setText("ควบคุมบอล");
		et_ability9.setText("แย่งบอล");
		et_ability10.setText("เข้าปะทะ");
		et_ability11.setText("สไลด์");
	...
	public void cb_th(){
		...
		et_ability2.setText("ความเร็ว");
		et_ability3.setText("ปฏิกิริยา");
		et_ability4.setText("กระโดด");
		et_ability5.setText("แข็งแกร่ง");
		et_ability6.setText("ส่งสั้น");
		et_ability7.setText("ควบคุมบอล");
		et_ability8.setText("แย่งบอล");
		et_ability9.setText("เข้าปะทะ");
		et_ability10.setText("สไลด์");
		et_ability11.setText("ประกบตัว");
		et_ability12.setText("การบุก");
	...
	public void sw_th(){
		et_star.setText("Skill Moves");
		et_ability1.setText("โหม่งบอล");
		et_ability2.setText("ปฏิกิริยา");
		et_ability3.setText("กระโดด");
		et_ability4.setText("แข็งแกร่ง");
		et_ability5.setText("ส่งสั้น");
		et_ability6.setText("ควบคุมบอล");
		et_ability7.setText("แย่งบอล");
		et_ability8.setText("เข้าปะทะ");
		et_ability9.setText("สไลด์");
		et_ability10.setText("ประกบตัว");
		et_ability11.setText("การบุก");
		et_ability12.setText(null);
		et_ability13.setText(null);
		et_ability14.setText(null);
		et_ability15.setText(null);
	...
	public void gk_th(){
		et_star.setText("Skill Moves");
		et_ability1.setText("ปฏิกิริยา");
		et_ability2.setText("GK พุ่งรับ");
		et_ability3.setText("GK รับบอล");
		et_ability4.setText("GK ส่งบอล");
		et_ability5.setText("GK ปฏิกิริยา");
		et_ability6.setText("GK ยืนตำแหน่ง");
		et_ability7.setText(null);
		et_ability8.setText(null);
		et_ability9.setText(null);
		et_ability10.setText(null);
	...
	public void all_th(){
		...
		et_ability23.setText("แย่งบอล");
		et_ability24.setText("อ่านเกม");
		et_ability25.setText("เข้าปะทะ");
		et_ability26.setText("สไลด์");
		et_ability27.setText("ประกบตัว");
		et_ability28.setText("การบุก");
		et_ability29.setText("GK พุ่งรับ");
		et_ability30.setText("GK รับบอล");
		et_ability31.setText("GK ส่งบอล");
		et_ability32.setText("GK ปฏิกิริยา");
		et_ability33.setText("GK ยืนตำแหน่ง");
		//et_ability34.setText("GK ยืนตำแหน่ง");
		//et_ability35.setText("ศักยภาพ");
	...
	public void st_vi(){
		...
		et_ability6.setText("Chọn vị trí");
		et_ability7.setText("Tốc độ");
		et_ability8.setText("Tăng tốc");
		et_ability9.setText("Phản ứng");
		et_ability10.setText("Sức mạnh");
		et_ability11.setText("Chuyền ngắn");
	...
	public void cm_vi(){
		...
		et_ability6.setText("Chuyền ngắn");
		et_ability7.setText("Chuyền dài");
		et_ability8.setText("Giữ bóng");
		et_ability9.setText("Rê bóng");
		et_ability10.setText("Cắt bóng");
		et_ability11.setText("Tầm nhìn");
		et_ability12.setText("Xoạc bóng");
		et_ability13.setText(null);
		et_ability14.setText(null);
		et_ability15.setText(null);
		et_ability16.setText(null);
	...
	public void cdm_vi(){
		...
		et_ability2.setText("Thể lực");
		et_ability3.setText("Sức mạnh");
		et_ability4.setText("Chuyền ngắn");
		et_ability5.setText("Chuyền dài");
		et_ability6.setText("Giữ bóng");
		et_ability7.setText("Cắt bóng");
		et_ability8.setText("Tầm nhìn");
	...
	public void wb_vi(){
		et_star.setText("Skill Moves");
		et_ability1.setText("Tốc độ");
		et_ability2.setText("Tăng tốc");
		et_ability3.setText("Phản ứng");
		et_ability4.setText("Thể lực");
		et_ability5.setText("Chuyền ngắn");
		et_ability6.setText("Tạt bóng");
		et_ability7.setText("Giữ bóng");
		et_ability8.setText("Rê bóng");
	...
	public void b_vi(){
		...
		et_ability2.setText("Tốc độ");
		et_ability3.setText("Tăng tốc");
		et_ability4.setText("Phản ứng");
		et_ability5.setText("Thể lực");
		et_ability6.setText("Chuyền ngắn");
		et_ability7.setText("Tạt bóng");
		et_ability8.setText("Giữ bóng");
		et_ability9.setText("Cắt bóng");
		et_ability10.setText("Xoạc bóng");
		et_ability11.setText("Tranh bóng");
	...
	public void cb_vi(){
		...
		et_ability2.setText("Tốc độ");
		et_ability3.setText("Phản ứng");
		et_ability4.setText("Nhảy");
		et_ability5.setText("Sức mạnh");
		et_ability6.setText("Chuyền ngắn");
		et_ability7.setText("Giữ bóng");
		et_ability8.setText("Cắt bóng");
		et_ability9.setText("Xoạc bóng");
		et_ability10.setText("Tranh bóng");
		et_ability11.setText("Kèm người");
		et_ability12.setText("Quyết đoán");
	...
	public void sw_vi(){
		et_star.setText("Skill Moves");
		et_ability1.setText("Đánh đầu");
		et_ability2.setText("Phản ứng");
		et_ability3.setText("Nhảy");
		et_ability4.setText("Sức mạnh");
		et_ability5.setText("Chuyền ngắn");
		et_ability6.setText("Giữ bóng");
		et_ability7.setText("Cắt bóng");
		et_ability8.setText("Xoạc bóng");
		et_ability9.setText("Tranh bóng");
		et_ability10.setText("Kèm người");
		et_ability11.setText("Quyết đoán");
		et_ability12.setText(null);
		et_ability13.setText(null);
		et_ability14.setText(null);
		et_ability15.setText(null);
	...
	public void gk_vi(){
		et_star.setText("Skill Moves");
		et_ability1.setText("Phản ứng");
		et_ability2.setText("TM đổ người");
		et_ability3.setText("TM bắt bóng");
		et_ability4.setText("TM phát bóng");
		et_ability5.setText("TM phản xạ");
		et_ability6.setText("TM Chọn vị trí");
		et_ability7.setText(null);
		et_ability8.setText(null);
		et_ability9.setText(null);
		et_ability10.setText(null);
	...
	public void all_vi(){
		...
		et_ability23.setText("Cắt bóng");
		et_ability24.setText("Tầm nhìn");
		et_ability25.setText("Xoạc bóng");
		et_ability26.setText("Tranh bóng");
		et_ability27.setText("Kèm người");
		et_ability28.setText("Quyết đoán");
		et_ability29.setText("TM đổ người");
		et_ability30.setText("TM bắt bóng");
		et_ability31.setText("TM phát bóng");
		et_ability32.setText("TM phản xạ");
		et_ability33.setText("TM Chọn vị trí");
		//et_ability34.setText("TM One On One");
		//et_ability35.setText("Potential");
